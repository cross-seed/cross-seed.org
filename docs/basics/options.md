...
prefixed by their client type. Found cross seeds will be injected only into
the client that the torrent was sourced from. If there similar torrents in
multiple clients, the order of the clients defined will be used as the priority.
