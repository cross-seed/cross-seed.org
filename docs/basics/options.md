...
:::info Note for v6
For the time/duration based options that allow it, you can pass `undefined` to disable an option
you have set in your config for the `cross-seed command` being used.
:::
