...
You'll need **Node.js 20** or greater. You can check your version with the
following command:
...
If the above command returns a version number of `20.x.x` or greater, you can
...
-   [**`torrentClients`**](../tutorials/injection.md): URLs of your torrent clients.
-   [**`linkDirs`**](../tutorials/linking.md): Directories where your data is linked to (optional but **_strongly_** recommended)
