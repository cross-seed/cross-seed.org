...
Some common errors are also listed in the [FAQ and Troubleshooting page](./faq-troubleshooting).
...
-   [**Explore cross-seed's configuration options**](./options.md) to customize
