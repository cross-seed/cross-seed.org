...
:::tip
It is now also possible to use `undefined` for the time/duration based options in your CLI command if you wish to override them without changing your config file.

```shell
cross-seed search --exclude-older undefined
```
